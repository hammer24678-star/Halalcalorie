...
const kTitles = <AscentTitle>[
  ...
  // ── Strength ladder ──
  AscentTitle(id: 25, glyph: '🥉', nameAr: 'أول رفعة', nameEn: 'First Lift',
      descAr: 'سجّل أول مجموعة مصنّفة', descEn: 'Log your first ranked set'),
  AscentTitle(id: 26, glyph: '🥈', nameAr: 'فضي', nameEn: 'Silver Standard',
      descAr: 'ابلغ رتبة الفضة عموماً', descEn: 'Reach Silver overall'),
  AscentTitle(id: 27, glyph: '🥇', nameAr: 'ذهبي', nameEn: 'Gold Standard',
      descAr: 'ابلغ رتبة الذهب عموماً', descEn: 'Reach Gold overall'),
  AscentTitle(id: 28, glyph: '💠', nameAr: 'ماسي', nameEn: 'Diamond Standard',
      descAr: 'ابلغ رتبة الماس عموماً', descEn: 'Reach Diamond overall'),
  AscentTitle(id: 29, glyph: '🧱', nameAr: 'الأساسيات', nameEn: 'The Big Three',
      descAr: 'صنّف السكوات والبنش والرفعة الميتة',
      descEn: 'Rank squat, bench and deadlift'),
  AscentTitle(id: 30, glyph: '🗺️', nameAr: 'شامل', nameEn: 'All-Rounder',
      descAr: 'صنّف تمريناً من كل مجموعة عضلية',
      descEn: 'Rank a lift in every muscle group'),
];
