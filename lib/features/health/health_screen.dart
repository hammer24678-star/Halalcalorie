        ...
        Padding(
          ...
          SizedBox(width: 96, height: 96,
            child: Stack(alignment: Alignment.center, children: [
              ...
              Text('$total',
                  style: TextStyle(fontFamily: 'Aligarh', fontSize: 32,
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          RichText(text: TextSpan(children: [
            TextSpan(text: '${water.cups}',
                style: const TextStyle(fontFamily: 'Aligarh', fontSize: 36,
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border(
                left: BorderSide(color: artColor, width: 4),
              ),
              boxShadow: [BoxShadow(
