...
// ── Health Article ──────────────────────────────
// PATCH_V32_HEALTH_ARTICLE_ICONS: iconAsset is the new illustrated badge; `icon` (the
...
const kHealthArticles = [
  HealthArticle(id:'h1', icon:'💧', iconAsset:'water', colorValue:0xFF2196F3, title:'الماء والإماهة',
  ...
  HealthArticle(id:'h2', icon:'😴', iconAsset:'sleep', colorValue:0xFF7C4DFF, title:'النوم والتعافي',
  ...
  HealthArticle(id:'h3', icon:'❤️', iconAsset:'heart', colorValue:0xFFE53935, title:'أرقام القلب التي تُقاس',
  ...
  HealthArticle(id:'h4', icon:'🧠', iconAsset:'brain', colorValue:0xFF00ACC1, title:'التركيز والذاكرة',
  ...
  HealthArticle(id:'h5', icon:'🦴', iconAsset:'bones', colorValue:0xFFFF7043, title:'العظام والمفاصل',
  ...
  HealthArticle(id:'h6', icon:'🥗', iconAsset:'digestion_fiber', colorValue:0xFF4CAF50, title:'الهضم والألياف',
  ...
  HealthArticle(id:'h7', icon:'🧘', iconAsset:'stress_relax', colorValue:0xFF9C27B0, title:'الضغط النفسي والاسترخاء',
  ...
  HealthArticle(id:'h8', icon:'⚖️', iconAsset:'weight_bmi', colorValue:0xFFFF5722, title:'الوزن ومؤشر كتلة الجسم',
  ...
  HealthArticle(id:'h9', icon:'🏷️', iconAsset:'label_reading', colorValue:0xFF009688, title:'قراءة الملصق الغذائي', // PATCH_V37_ICON_OVERHAUL: distinct glyph + real icon, stops matching h6's salad bowl even on fallback
  ...
  HealthArticle(id:'h10', icon:'🩸', iconAsset:'checkup_blood', colorValue:0xFFF44336, title:'المتابعة الدورية',
